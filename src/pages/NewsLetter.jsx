...
const magazineLinks = [
  {
    ...
    cover: "/data/newsletterData/Volume1cover.png",
    link: "/data/newsletterData/Pulse-Volume-1.pdf",
  },
  {
    id: 2,
    ...
    cover: "/data/newsletterData/Volume2cover.png",
    link: "/data/newsletterData/Pulse-Volume-2.pdf",
  },
  {
    id: 3,
    ...
    cover: "/data/newsletterData/Volume3cover.png",
    link: "/data/newsletterData/Pulse-Volume-3.pdf",
  },
  {
    id: 4,
    ...
    cover: "/data/newsletterData/Volume4cover.png",
    link: "/data/newsletterData/Pulse-Volume-4.pdf",
  },
  {
    id: 5,
    title: "Fifth Edition of Pulse",
    minidescription: "",
    cover: "/data/newsletterData/Volume5cover.png",
    link: "/data/newsletterData/Pulse-Volume-5.pdf",
  },
  {
    id: 6,
...
//   const [currentMagazine, setCurrentMagazine] = useState(3);
  ...
  const navigateMagazine = (direction) => {
    if (direction === "next") {
