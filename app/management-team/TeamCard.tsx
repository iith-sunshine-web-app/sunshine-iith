...
const TeamMember: React.FC<TeamMemberProps> = ({
  ...
  return (
    <div className="w-full sm:w-[80%] md:w-1/3 lg:w-[30%] xl:w-1/4 p-2 relative">
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="relative">
          <img
            src={photoUrl}
            alt={name}
            className="w-full aspect-[5/6] md:h-80  object-cover rounded-t-lg lg:hover:scale-105 overflow-y-auto transition-transform duration-500"
          />
        </div>
