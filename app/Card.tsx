...
import Notification from "./ComingSoon";
...
export default function FeaturesBlocks() {
  ...
  return (
    <>
      ...
      {isCopied && <Notification message="Phone number copied !!" />}
      {isCopied2 && <Notification message="Phone number copied !!" />}
      {isCopied3 && <Notification message="Phone number copied !!" />}
    </>
  );
}
